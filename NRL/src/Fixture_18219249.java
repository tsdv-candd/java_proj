...
public class Fixture_18219249 {
	...
	public Fixture_18219249(int matchNumber, int roundNumber, String homeName,
			String awayName, String Venue, Date kickoffTime, Date date) {
	...
	public void display(boolean isHomeTeam) {
		...
		if (isHomeTeam) {
			...
			System.out.format(leftAlignFormat, roundNumber, date, awayTeamName,
					status, homeTeamScore, awayTeamScore);
		} else {
			String status;
			if (homeTeamScore > awayTeamScore) {
				status = "Loss";
			...
			System.out.format(leftAlignFormat, roundNumber, date, homeTeamName,
					status, homeTeamScore, awayTeamScore);
		}
	}
}
