...
public class Team_18219249 implements Comparable<Team_18219249> {
	 ...
	 * @param : int check check if the match is byes, at home or at away
	 *          stadium.
	 * @retval : None
	 *****************************************************************************/
	public void update(int homeScore, int awayScore, int check) {
		...
		int numberGameDraws = numberGamePlayeds
				- (numberGameWons + numberGameLosts);
	 ...
	 * @retval : return 0 if two team's total score are equal, return > 0 if
	 *         this team's total score is higher return < 0 if this team's total
	 *         score is lower than input team.
	 *****************************************************************************/
	 ...
	 * @param : int currentRound Current round number which user input at
	 *        startup
	 * @retval None.
	 *****************************************************************************/
	public void showResult(int currentRound, Fixture_18219249[][] fx) {
		...
		System.out.println();
		System.out.println("Total competition poins after " + currentRound
				+ " rounds: " + totalPoints);
		System.out.println();
	}
}
